%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Environment Tobago newsletter template
% based on LaTeX 
% Version 1.0 (06/04/2020)
%
% Created by:
% Bertrand (https://bhikarry.net)
% 
% The base for this template was been downloaded from:
...
\input{structure.tex} % bringing in the document which specifies all packages and structural customisations for this template
...
\begin{figure}[H]
\centering\includegraphics[width=.98\linewidth]{logo.png}
\end{figure}
...
\item \hyperlink{quotation}{Notable quotation}
\end{itemize}
...
\includegraphics[width=0.2\textwidth]{declaration}
\end{wrapfigure}
...
\begin{figure}[H]
	\includegraphics [width=0.9\textwidth]{screenshot1}
\end{figure}
...
\hypertarget{quotation}{{\large Quote of the Quarter}} % \hypertarget provides a label to reference using \hyperlink{label}{link text}
...
Tel: (868) 660 7467 \\
\email{office@environmenttobago.net} \\
\href{https://environmenttobago.net}{https://environmenttobago.net}\\
\href{https://blog.environmenttobago.net}{https://blog.environmenttobago.net} 
\end{minipage}
